...
public class WhenAndWhereContextFactory : IDesignTimeDbContextFactory<WhenAndWhereDBContext>
{
    public WhenAndWhereDBContext CreateDbContext(string[] args)
    {
        ...
        optionsBuilder.UseNpgsql("Server=hw2-postgresql.postgres.database.azure.com;Database=whenandwhere;Port=5432;User Id=postgres;Password=evaelfieis120%hot;Ssl Mode=Require; Trust Server Certificate=true;")
